...
export const Site = new MoveStruct({
    name: `${$moduleName}::Site`,
    fields: {
        id: object.UID,
        name: bcs.string(),
...
export const Resource = new MoveStruct({
...
export const ResourcePath = new MoveStruct({
    name: `${$moduleName}::ResourcePath`,
    fields: {
        path: bcs.string(),
    },
})
export const Routes = new MoveStruct({
...
export interface NewSiteOptions {
    ...
    arguments:
        | NewSiteArguments
        | [name: RawTransactionArgument<string>, metadata: RawTransactionArgument<string>]
}
/** Creates a new site. */
...
export interface UpdateNameOptions {
    ...
    arguments:
        | UpdateNameArguments
        | [site: RawTransactionArgument<string>, newName: RawTransactionArgument<string>]
}
...
export interface UpdateMetadataOptions {
    ...
    arguments:
        ...
        | [site: RawTransactionArgument<string>, metadata: RawTransactionArgument<string>]
}
...
export interface AddResourceOptions {
    package?: string
    arguments:
        | AddResourceArguments
        | [site: RawTransactionArgument<string>, resource: RawTransactionArgument<string>]
}
...
export interface RemoveResourceOptions {
    ...
    arguments:
        ...
        | [site: RawTransactionArgument<string>, path: RawTransactionArgument<string>]
}
/**
...
export interface RemoveResourceIfExistsOptions {
    package?: string
    arguments:
        | RemoveResourceIfExistsArguments
        | [site: RawTransactionArgument<string>, path: RawTransactionArgument<string>]
}
...
export interface CreateRoutesOptions {
    package?: string
    arguments: CreateRoutesArguments | [site: RawTransactionArgument<string>]
}
/** Add the routes dynamic field to the site. */
export function createRoutes(options: CreateRoutesOptions) {
    const packageAddress = options.package ?? '@walrus/sites'
    const argumentsTypes = [`${packageAddress}::site::Site`] satisfies string[]
...
export interface RemoveAllRoutesIfExistOptions {
    package?: string
    arguments: RemoveAllRoutesIfExistArguments | [site: RawTransactionArgument<string>]
}
...
export interface RemoveRouteOptions {
    ...
    arguments:
        ...
        | [site: RawTransactionArgument<string>, route: RawTransactionArgument<string>]
}
...
export interface BurnOptions {
    package?: string
    arguments: BurnArguments | [site: RawTransactionArgument<string>]
}
/**
...
export interface GetSiteNameOptions {
    package?: string
    arguments: GetSiteNameArguments | [site: RawTransactionArgument<string>]
}
...
export interface GetSiteLinkOptions {
    package?: string
    arguments: GetSiteLinkArguments | [site: RawTransactionArgument<string>]
}
...
export interface GetSiteImageUrlOptions {
    package?: string
    arguments: GetSiteImageUrlArguments | [site: RawTransactionArgument<string>]
}
...
export interface GetSiteDescriptionOptions {
    package?: string
    arguments: GetSiteDescriptionArguments | [site: RawTransactionArgument<string>]
}
...
export interface GetSiteProjectUrlOptions {
    package?: string
    arguments: GetSiteProjectUrlArguments | [site: RawTransactionArgument<string>]
}
...
export interface GetSiteCreatorOptions {
    package?: string
    arguments: GetSiteCreatorArguments | [site: RawTransactionArgument<string>]
}
