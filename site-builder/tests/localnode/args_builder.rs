...
impl ArgsBuilder {
    ...
    pub fn with_config(mut self, config: Option<PathBuf>) -> Self {
        self.general.config = config;
        self
    }

    pub fn with_context(mut self, context: Option<String>) -> Self {
        self.general.context = context;
        self
    }
    ...
    pub fn with_walrus_binary(mut self, walrus_binary: Option<String>) -> Self {
        self.general.walrus_binary = walrus_binary;
        self
    }
    ...
    pub fn with_gas_budget(mut self, gas_budget: Option<u64>) -> Self {
        self.general.gas_budget = gas_budget;
        self
    }
